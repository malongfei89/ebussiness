<template>
<div @click="closeLoginPopup">
  <Header>
    <template #customized1>
      <button style="font-weight:bold;padding:46px 0;width:100%" @click.stop="showLoginPopup">Register/Login</button>
    </template>
  </Header>
  <main>
    <div id="home-main">
    ...
    <div class="loginPopup" @click.stop>
